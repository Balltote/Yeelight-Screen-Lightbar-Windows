...
def ok(event):
    if combobox_dropdown.get() == "Alarm":
        ...
        bulb.start_flow(yl.flows.home(duration=500, brightness=80), light_type=LightType.Ambient)
    ...
    elif combobox_dropdown.get() == "Pulse":
        bulb.start_flow(yl.flows.pulse(255, 13, 13, duration=1000, brightness=100, count=0), light_type=LightType.Ambient)
    ...
    elif combobox_dropdown.get() == "Temperature":
